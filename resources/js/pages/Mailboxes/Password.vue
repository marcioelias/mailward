...
<template>
    ...
    <AppLayout
        ...
        :subtitle="mailbox.name ? `${mailbox.username} — ${mailbox.name}` : mailbox.username"
    >
        <div class="me-stack">
            <!--
            ...
            <MeAlert variant="warning">
                This is the account's real mail password. Saving changes IMAP, SMTP and webmail
                at the same moment, and signs the person out of every mail client they use until
            ...
            <MeAlert v-if="mailbox.weakness" variant="info">
                ...
                {{ mailbox.weakness }} The account works — this is worth changing, not urgent.
            </MeAlert>

            <MeCard title="Suggested password" description="Generated in your browser. Nothing is sent until you save.">
                <div class="me-stack">
                    <p class="me-suggestion">{{ suggestion }}</p>

                    <p class="me-hint">
                        Sixteen characters, grouped so it survives being read aloud. No
                        <code>0</code>/<code>O</code> or <code>1</code>/<code>l</code>/<code>I</code>,
                        which is what gets mistyped on a phone.
                    </p>
                    ...
                    <div class="me-row">
                        ...
                        <MeButton variant="secondary" @click="rotate">Suggest another</MeButton>
                    </div>
                </div>
            </MeCard>
                ...
                <MeCard title="New password">
                    <div class="me-stack">
                        ...
                        <div class="me-row me-row--between">
                            ...
                            <MeButton type="submit" variant="danger" :disabled="form.processing">
