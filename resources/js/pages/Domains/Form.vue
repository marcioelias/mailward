...
<template>
    ...
    <form class="me-stack" @submit.prevent="submit">
        ...
        <MeCard>
            <div class="me-stack">
                <MeField
                    ...
                    :hint="
                        editing
                            ? 'The name is the primary key and cannot be changed here.'
                            : ''
                    "
                >
                    <MeInput
        ...
        <MeCard
            title="Limits"
            description="Zero means unlimited, not zero allowed."
        >
            <div class="me-stack">
                <MeField
                    label="Mailboxes"
